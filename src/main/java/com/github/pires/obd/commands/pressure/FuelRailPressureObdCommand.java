...
public class FuelRailPressureObdCommand extends PressureObdCommand {

    public FuelRailPressureObdCommand() {
        super("01 23");
    }

    /**
     * @param other a {@link FuelRailPressureObdCommand} object.
     */
