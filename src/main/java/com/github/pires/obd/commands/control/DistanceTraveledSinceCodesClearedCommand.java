 ...
 */
public class DistTravSinceCCCommand extends ObdCommand
     ...
     * Copy ctor.
     *
     * @param other a {@link DistTravSinceCCCommand} object.
     */
    public DistTravSinceCCCommand(
            DistTravSinceCCCommand other) {
        super(other);
    }
