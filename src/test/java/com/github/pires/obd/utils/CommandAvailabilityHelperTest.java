...
public class CommandAvailabilityHelperTest {
	...
	public void testDigestAvailabilityString() throws Exception {
		...
		expected = new int[] { Integer.parseInt("10111110", 2), Integer.parseInt("00011111", 2),
				Integer.parseInt("10101000", 2), Integer.parseInt("00010011", 2), Integer.parseInt("10111110", 2),
				Integer.parseInt("00011111", 2), Integer.parseInt("10101000", 2), Integer.parseInt("00010011", 2) };
	...
	public void testIsAvailable() throws Exception {
		...
		Assert.assertEquals(CommandAvailabilityHelper
				.isAvailable(new ThrottlePositionCommand().getCommandPID() /* 11 */, "BE1FA813"), true);
